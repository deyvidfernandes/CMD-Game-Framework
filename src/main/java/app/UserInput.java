...
public class UserInput {
	...
	UserInput(String input) throws InvalidUserInput {
				
			if (input.length() > 3) {
				throw new InvalidUserInput("overflow");
			}
			...
			try {
				...
				throw new InvalidUserInput(String.valueOf(String.valueOf(input.charAt(2))), "turns", "turns-invalid input");
			}
			...
			if (dirInput != null) {
				if ( !(dirInput.equals("w") || dirInput.equals("s") || dirInput.equals("d") || dirInput.equals("e") || dirInput.equals("a")) ) {
					throw new InvalidUserInput(dirInput, "direction", "direction-invalid input");
				} else {
					this.dir = dirInput;
				}
			} else {
